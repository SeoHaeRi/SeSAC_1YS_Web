...
import { Date, IDiary, RootState } from "../global/global";

export default function CreateDiary() {
  const dates: Date[] = useSelector((state: RootState) => state.dates);
  ...
  function onSubmit(e: any) {
    ...
    if (titleRef.current == null || dateRef.current == null || contentRef.current == null) return false;
    const data = {
      id: diaries.length + 1,
